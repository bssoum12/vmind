  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', gap: '16px', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '12px', marginBottom: '24px', padding: '0 8px' }}>
        <span style={{ fontSize: '12px', fontWeight: 700, color: '#fff', cursor: 'pointer' }}>Tous</span>
        <span style={{ fontSize: '12px', fontWeight: 600, color: '#6A7E95', cursor: 'pointer' }}>Connecté</span>
        <span style={{ fontSize: '12px', fontWeight: 600, color: '#6A7E95', cursor: 'pointer' }}>Non connecté</span>
      </div>
