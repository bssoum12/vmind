      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '14px', fontWeight: 800, color: '#F1F5F9', lineHeight: 1.2 }}>
            {((summary.total_poids_kg || 0) / 1000).toFixed(1)} <span style={{ fontSize: '10px', color: '#94A3B8', fontWeight: 600 }}>T.</span>
          </div>
          <div style={{ fontSize: '10px', color: '#38BDF8', fontWeight: 700, marginTop: '2px' }}>
            {summary.total_volume_m3 || 0} <span style={{ fontSize: '9px', color: '#64748B' }}>m³ total</span>
          </div>
        </div>
      </div>
