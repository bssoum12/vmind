/**
 * Liste des pays — nom (français) + code ISO 3166-1 alpha-2.
 * Le code ISO est inclus car c'est le format généralement attendu par les
 * API de sourcing (Hunter.io, etc.) pour filtrer par pays.
 *
 * Triée par ordre alphabétique du nom français.
 * Usage: dropdown / autocomplete pays dans le Sourcing Agent, Prospect Agent Wizard, filtre Hunter.io.
 */
...
export const COUNTRIES: Country[] = [
  ...
  { name: "Congo-Kinshasa (RDC)", code: "CD" },
